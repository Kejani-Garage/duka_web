...
export const sitePages = {
  grocery: {
    page_title: 'Grocery - Duka Mtaani',
  ...
  clothing: {
    page_title: 'Clothing - Duka Mtaani',
  ...
  furniture: {
    page_title: 'Furniture - Duka Mtaani',
  ...
  medicine: {
    page_title: 'Medicine - Duka Mtaani',
